...
Markit 0.5.3 converts supported document and data files to Markdown locally. Image descriptions and audio transcription are not enabled by this extension, so those formats provide the metadata Markit can extract without an LLM.
